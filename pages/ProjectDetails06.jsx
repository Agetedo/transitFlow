...
import serviceImage01 from "/service-details-image01.jpeg";
import serviceImage02 from "/service-details-image02.jpeg";
import airFrightIcon from "/we-do-icon03.png";
...
export default function ProjectDetails06() {
  return (
    <>
      <Header />
      <Heading 
        className={"heading"} 
        imageUrl={"/air-fright-heading-bg.jpeg"}
        caption={"Project Details"}
        title={"Transportation By Different Modes"}
      />
      <ServiceDetails 
        imgSrc01={serviceImage01} imgAlt01={"Cargo ship with containers on board"}
        iconSrc={airFrightIcon}
        title01={"Transportation By Different Modes"}
        text01={text01}
        text02={text02}
        title02={"Benefit of Service"}
        text03={text03}
        imgSrc02={serviceImage02} imgAlt02={"Convoy of trucks on the road"}
        title03={"Why Was The 'Transportation By Different Modes' Created?"}
        text04={text04}
        text05={text05}
