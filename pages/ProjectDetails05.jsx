...
import serviceImage01 from "/air-fright-services-image01.jpg";
...
export default function ProjectDetails05() {
  return (
    <>
      <Header />
      <Heading 
      ...
      />
      <ServiceDetails 
        imgSrc01={serviceImage01} imgAlt01={"The plane flies to the seaport"}
        iconSrc={airFrightIcon}
        title01={"To Anywhere In The World"}
        text01={text01}
        text02={text02}
        title02={"Benefit of Service"}
        text03={text03}
        imgSrc02={serviceImage02} imgAlt02={"Convoy of trucks on the road"}
        title03={"Why Was The 'To Anywhere In The World' Created?"}
        text04={text04}
        text05={text05}
